 ...
 * 
 * Functional Interface Example Predicate <T> interface is a functional
 * interface with a method test(Object) to return a Boolean value. This
 * interface signifies that an object is tested to be true or false.
 * 
 * @author thomas
 *
 */
