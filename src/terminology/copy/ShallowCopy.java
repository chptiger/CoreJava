 ...
 * original object. 
 * 
 * If original object has any references to other objects as
 ...
 * 
 * E.X:
 *  Course is a references in the Student. Shallow copy only copy the reference of the Course.
 *  Any update on the Course of student1, Course of student2 will be update also, vice-versa.
 *  Both student1 and student2 share the same Course references.
 */
class Course {
	String subject1;
